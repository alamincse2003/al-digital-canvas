...
const Banner = () => {
   ...
   const toRotate = ["Junior Web Developer", "Front-end Developer", "React Developer"];
   const period = 2000;
              ...
              <TrackVisibility>
                {({ isVisible }) => (
                  ...
                  >
                    ...
                    <h1>
                      {/* {`Hi! I am Al Amin`}  */}
                      <h3>Hi! I am Al Amin</h3>
                      <span
                        className="txt-rotate"
                        dataPeriod="1000"
                        data-rotate='["Junior Web Developer", "Front-end Developer", "React Developer"]'
                      >
